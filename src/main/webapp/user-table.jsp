...
<%--                                            <a href="<c:url value="/user/delete?id=${user.getId()}" />" class="btn btn-sm btn-danger">Xóa</a>--%>
                                            <span userid="${user.getId()}" class="btn btn-sm btn-danger btn-delete-user">Xóa</span>
